...
public class ChordProgression
{
	...
	public void Display(MusicScale scale, string elementId)
	{
		...
		MusicDisplay.Update(elementId, "Chord\\nProgression:", scale.m_fifths, scale.m_mode, noteCount, times, keys, Enumerable.Repeat(MusicUtility.sixtyFourthsPerBeat, noteCount).ToArray(), 0U); // NOTE that the bpm of 0 tells the update to use chord progression special formatting
	}
}
